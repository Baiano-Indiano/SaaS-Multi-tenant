    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          <div className="md:col-span-2 rounded-2xl border border-zinc-800 bg-zinc-900 p-8 flex flex-col relative overflow-hidden group">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-8 flex flex-col relative overflow-hidden group">
