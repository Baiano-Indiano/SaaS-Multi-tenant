          ...
          <ScrollReveal direction="left" className="md:col-span-2">
            <div className="h-full rounded-2xl border border-zinc-800 bg-zinc-900 p-8 flex flex-col relative overflow-hidden group">
              <h3 className="text-2xl font-semibold mb-2 relative z-10">
                {t('bento.schema.title')}
              </h3>
              <p className="text-zinc-400 relative z-10">
                {t('bento.schema.description')}
              </p>
      ...
      <section className="w-full border-t border-zinc-800 py-24 bg-gradient-to-b from-zinc-950 to-zinc-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <ScrollReveal>
            ...
            <Button size="lg" className="text-base px-8 py-6" render={<Link href="/register" />} nativeButton={false}>
              {t('cta.button')}
            </Button>
          </ScrollReveal>
        </div>
