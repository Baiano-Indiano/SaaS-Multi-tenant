          ...
          <div className="flex items-center justify-between px-4 py-2 bg-zinc-900/50 border-b border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 ml-2">
                ...
                <span className="font-bold tracking-widest text-[10px] text-zinc-400">SEC_AUDIT_LOG_V2.0</span>
              </div>
            </div>
            <button 
              onClick={onClose}
            ...
            <div className="flex-1 flex flex-col bg-[#050505] relative">
                  ...
                  {selectedLog ? (
                    ...
                    >
                      <div className="flex items-center gap-2 text-emerald-400 border-b border-emerald-500/20 pb-2">
                        ...
                        <span className="font-bold uppercase tracking-wider">Inspect Packet: {selectedLog.id.slice(0, 8)}</span>
                      </div>

                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-4">
                          <DetailItem label="TIMESTAMP" value={new Date(selectedLog.createdAt).toLocaleString()} />
                          <DetailItem label="SOURCE_IP" value={selectedLog.ip || "0.0.0.0"} />
                          <DetailItem label="ACTOR_ID" value={selectedLog.user || "SYSTEM_DAEMON"} />
                        </div>
                        <div className="space-y-4">
                          <DetailItem label="ACTION_TYPE" value={selectedLog.action} />
                          <DetailItem label="ENTITY_TARGET" value={selectedLog.entity || "GLOBAL"} />
                          <DetailItem label="PROTOCOL" value="HTTPS/WSS" />
                        </div>
                      </div>
                      ...
                      <div className="mt-8">
                        <div className="flex items-center gap-2 text-zinc-500 mb-2">
                          ...
                          <span className="text-[10px] font-bold">RAW_JSON_PAYLOAD</span>
                        </div>
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-zinc-700 opacity-50 space-y-4 py-20">
                      ...
                      <div className="text-center space-y-1">
                        <p className="font-bold uppercase tracking-[0.2em]">Awaiting Packet Selection</p>
                        <p className="text-[10px]">Select a security trace from the sidebar to begin inspection</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="h-8 border-t border-zinc-900 flex items-center px-4 justify-between bg-black">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] text-zinc-600 uppercase font-bold tracking-widest">System Operational</span>
                </div>
                <div className="text-[9px] text-zinc-800">
                  CTRL+C TO ABORT | CTRL+L TO CLEAR
                </div>
              </div>
            </div>
          </div>
